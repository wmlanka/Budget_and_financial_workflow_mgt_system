...
<body>
	...
	<div class="gridContainer">
		...
		<table style="width: 100%">
			<tr> 
				<td class="img-budget"><h3>Action Code</h3></td>
				<td style="text-align: right;"> 
					<h4><a href="addActionCodeAction?command=add">
		...
		<%-- 	<display:column value="<%=stkTable_rowNum%>"/> --%>
			...
			<display:column media="html">			
				<s:url var="editUrl" action="editActionCodeAction?command=update">
			  		<s:param name="actionId" value="%{#attr.row.actionId}" />
				</s:url>
				
				<s:url var="deleteUrl" action="deleteActionCodeAction">
			  		<s:param name="actionId" value="%{#attr.row.actionId}" />
				</s:url>
